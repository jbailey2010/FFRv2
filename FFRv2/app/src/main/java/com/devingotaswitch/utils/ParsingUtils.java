...
public class ParsingUtils {
    ...
    private static void initHashes() {
        ...
        playerFixes.put("Melvin Gordon III", "Melvin Gordon");
        playerFixes.put("D.K. Metcalf", "DK Metcalf");
        ...
        teamFixes.put("cle1", "Cleveland Browns");
        ...
        teamFixes.put("den3", "Denver Broncos");
        ...
        teamFixes.put("atl2", "Atlanta Falcons");
    ...
    public static Player conditionallyAddContext(Player oldPlayer, Player newPlayer) {
        ...
        if ((oldPlayer.getExperience() == null || oldPlayer.getExperience() < 0)  && newPlayer.getExperience() != null) {
