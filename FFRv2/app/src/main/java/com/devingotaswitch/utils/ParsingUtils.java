...
public class ParsingUtils {
    ...
    private static void initHashes() {
        ...
        playerFixes.put("LeVeon Bell", "Le'Veon Bell");
        playerFixes.put("QB Eagles No. 7", "Michael Vick");
        playerFixes.put("Robert Griffin", "Robert Griffin III");
        playerFixes.put("Jonathan Baldwin", "Jon Baldwin");
        playerFixes.put("Chris Wells", "Beanie Wells");
        playerFixes.put("Steve L. Smith", "Steve Smith");
        ...
        playerFixes.put("Stevie Johnson", "Steve Johnson");
        playerFixes.put("Robert Housler", "Rob Housler");
        playerFixes.put("Christopher Ivory", "Chris Ivory");
        playerFixes.put("R. Mendenhall", "Rashard Mendenhall");
        playerFixes.put("B. Green-Ellis", "BenJarvus Green-Ellis");
        playerFixes.put("BJGE", "BenJarvus Green-Ellis");
        playerFixes.put("Joseph Morgan", "Joe Morgan");
        playerFixes.put("E.j. Manuel", "EJ Manuel");
        ...
        playerFixes.put("Darren Mcfadden", "Darren McFadden");
        playerFixes.put("Robert Griffin, III", "Robert Griffin III");
        playerFixes.put("Rashad Mendenhall", "Rashard Mendenhall");
        playerFixes.put("Le`Veon Bell", "Le'Veon Bell");
        playerFixes.put("Benjarvus Green-Ellis", "BenJarvus Green-Ellis");
